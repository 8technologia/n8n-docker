# n8n-docker
Cài N8N sử dụng docker compose kết hợp với Cloudflare Tunel

Bước 1: Vào Cloudflare Tunel thiết lập để lấy token
...
Bước 4: Trong cấu hình của Cloudflare Tunel. Mục Service chọn Type là HTTP - URL localhost:5678 là xong
